...
export class Client {
  ...
  auth(params: {
    ...
    return this.api.post("https://listen-and-type-git-dev-allenpeaces-projects.vercel.app/api/sessions", decamelizeKeys(params));
  }
  ...
  me(): Promise<UserType> {
    return this.api.get("https://listen-and-type-git-dev-allenpeaces-projects.vercel.app/api/me");
  }
  ...
  syncRecording(recording: Partial<RecordingType>) {
    ...
    return this.api.post("https://listen-and-type-git-dev-allenpeaces-projects.vercel.app/api/mine/recordings", decamelizeKeys(recording));
  }
  ...
  generateSpeechToken(params?: {
    ...
    return this.api.post("https://listen-and-type-git-dev-allenpeaces-projects.vercel.app/api/speech/tokens", decamelizeKeys(params || {}));
  }
